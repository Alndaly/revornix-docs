...
因此，我把通知功能从整体逻辑中抽离了出来，避免过度的通知对部分用户造成困扰。
...
![](https://qingyon-revornix-public.oss-cn-beijing.aliyuncs.com/images/20260204184702812.png)
...
<Callout>
	这种方式适合开发者使用，即你必须要具备该设备在你应用下的唯一ID
</Callout>
